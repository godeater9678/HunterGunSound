...
HunterGunSoundInfo = {
    ...
    -- 지원 언어
    supportedLocales = {
        "koKR", "enUS", "frFR", "deDE", "esES", "esMX", 
        "itIT", "ptBR", "ruRU", "zhCN", "zhTW"
    },
...
-- 현재 버전의 변경사항 반환
function HunterGunSoundInfo:GetCurrentVersionChanges()
    return self.versionHistory[self.version] and self.versionHistory[self.version].changes or {}
end
