...
local function onEvent(self, event, ...)
	...
	elseif (event == "PLAYER_LOGIN") then
		print("|cFFFFDF00HunterGunSound loaded! Modified by |cFFFF69B4-낭만냥꾼-|r")
		print("|cFFFFDF00Type |cFF003FFF/hgs|cFFFFDF00 to open settings or |cFF003FFF/ogs|cFFFFDF00 to toggle sounds|r")
...
if GetLocale() == "koKR" then
    ...
    L.Credits = "Modified by |cFFFF69B4-낭만냥꾼-|r"
else
    L.Title = "HunterGunSound Settings - |cFFFF69B4Romantic Hunter|r Edition"
    ...
    L.VolumeLoud = "Loud"
    L.OnText = "|cFFFFDF00Hunter Gun Sounds are ON"
    L.OffText = "|cFFFFDF00Hunter Gun Sounds are OFF"
    ...
    L.Credits = "Modified by |cFFFF69B4-Romantic Hunter-|r"
end
